      ...
      unzoom: function () {
          ...
          if ($$.scale.zoom) {
              config.subchart_show ?
                  ...
                  $$.zoom.updateTransformScale(identity);
              $$.updateZoom(true);
              $$.zoom.resetBtn && $$.zoom.resetBtn.style("display", "none");
              // reset transform
              var eventRects = $$.$el.main.select("." + CLASS.eventRects);
              if (transform$1(eventRects.node()) !== identity) {
                  $$.zoom.transform(eventRects, identity);
              }
              $$.redraw({
                  withTransition: true,
                  withUpdateXDomain: true,
  ...
  var DATA = [
  	{
  		...
  		Seances: 4141.6,
  		Entrees: 175.4,
  		RecetteGuichet: 430.7,
  		RecetteMoyenneEntree: 2.46
  	},
  	{
  		Annee: 1981,
  		Seances: 3715.1,
  		Entrees: 189.2,
  		RecetteGuichet: 529.3,
  		RecetteMoyenneEntree: 2.8
  	},
  	{
  		Annee: 1982,
  		Seances: 3872.8,
  		Entrees: 201.9,
  		RecetteGuichet: 630.7,
  		RecetteMoyenneEntree: 3.12
  	},
  	{
  		Annee: 1983,
  		Seances: 4037.1,
  		Entrees: 198.9,
  		RecetteGuichet: 671.3,
  		RecetteMoyenneEntree: 3.38
  	},
  	{
  		Annee: 1984,
  		Seances: 4320.8,
  		Entrees: 190.9,
  		RecetteGuichet: 682.6,
  		RecetteMoyenneEntree: 3.58
  	},
  	{
  		Annee: 1985,
  		Seances: 4418.7,
  		Entrees: 175.1,
  		RecetteGuichet: 665.9,
  		RecetteMoyenneEntree: 3.8
  	},
  	{
  		Annee: 1986,
  		Seances: 4461.2,
  		Entrees: 168.1,
  		RecetteGuichet: 675.7,
  		RecetteMoyenneEntree: 4.02
  	},
  	{
  		Annee: 1987,
  		Seances: 4333.4,
  		Entrees: 136.9,
  		RecetteGuichet: 577.5,
  		RecetteMoyenneEntree: 4.22
  	},
  	{
  		Annee: 1988,
  		Seances: 3995.7,
  		Entrees: 124.7,
  		RecetteGuichet: 553.7,
  		RecetteMoyenneEntree: 4.44
  	},
  	{
  		Annee: 1989,
  		Seances: 3887,
  		Entrees: 120.9,
  		RecetteGuichet: 560.8,
  		RecetteMoyenneEntree: 4.64
  	},
  	{
  		Annee: 1990,
  		Seances: 3795.3,
  		Entrees: 121.9,
  		RecetteGuichet: 583.3,
  		RecetteMoyenneEntree: 4.78
  	},
  	{
  		Annee: 1991,
  		Seances: 3709.8,
  		Entrees: 117.5,
  		RecetteGuichet: 591.7,
  		RecetteMoyenneEntree: 5.04
  	},
  	{
  		Annee: 1992,
  		Seances: 3599,
  		Entrees: 116,
  		RecetteGuichet: 600.8,
  		RecetteMoyenneEntree: 5.18
  	},
  	{
  		Annee: 1993,
  		Seances: 3717.5,
  		Entrees: 132.7,
  		RecetteGuichet: 688.9,
  		RecetteMoyenneEntree: 5.19
  	},
  	{
  		Annee: 1994,
  		Seances: 3778.6,
  		Entrees: 124.4,
  		RecetteGuichet: 653.5,
  		RecetteMoyenneEntree: 5.25
  	},
  	{
  		Annee: 1995,
  		Seances: 3909.5,
  		Entrees: 130.2,
  		RecetteGuichet: 690.1,
  		RecetteMoyenneEntree: 5.3
  	},
  	{
  		Annee: 1996,
  		Seances: 4211.2,
  		Entrees: 136.7,
  		RecetteGuichet: 726,
  		RecetteMoyenneEntree: 5.31
  	},
  	{
  		Annee: 1997,
  		Seances: 4493.4,
  		Entrees: 149.3,
  		RecetteGuichet: 790.2,
  		RecetteMoyenneEntree: 5.29
  	},
  	{
  		Annee: 1998,
  		Seances: 4627.6,
  	...
  	},
  	{
  		...
  		Entrees: 184.4,
  		RecetteGuichet: 1030,
  		RecetteMoyenneEntree: 5.59
  	},
  	{
  		Annee: 2003,
  		Seances: 5773.5,
  		Entrees: 173.5,
  		RecetteGuichet: 996.1,
  		RecetteMoyenneEntree: 5.74
  	},
  	{
  		Annee: 2004,
  		Seances: 6054.4,
  		Entrees: 195.8,
  		RecetteGuichet: 1139.8,
  		RecetteMoyenneEntree: 5.82
  	},
  	{
  		Annee: 2005,
  		Seances: 6087.8,
  		Entrees: 175.6,
  		RecetteGuichet: 1031.8,
  		RecetteMoyenneEntree: 5.87
  	},
  	{
  		Annee: 2006,
  		Seances: 6239.7,
  		Entrees: 188.8,
  		RecetteGuichet: 1120.6,
  		RecetteMoyenneEntree: 5.94
  	},
  	{
  		Annee: 2007,
  		Seances: 6295.9,
  		Entrees: 178.5,
  		RecetteGuichet: 1061.9,
  		RecetteMoyenneEntree: 5.95
  	},
  	{
  		Annee: 2008,
  		Seances: 6581.7,
  		Entrees: 190.3,
  		RecetteGuichet: 1142.9,
  		RecetteMoyenneEntree: 6.01
  	},
  	{
  		Annee: 2009,
  		Seances: 6708.6,
  		Entrees: 201.6,
  		RecetteGuichet: 1237.2,
  		RecetteMoyenneEntree: 6.14
  	},
  	{
  		Annee: 2010,
  		Seances: 6844.8,
  		Entrees: 207.1,
  		RecetteGuichet: 1309.9,
  		RecetteMoyenneEntree: 6.33
  	},
  	{
  		Annee: 2011,
  		Seances: 7044.5,
  		Entrees: 217.2,
  		RecetteGuichet: 1374.7,
  		RecetteMoyenneEntree: 6.33
  	},
  	{
  		Annee: 2012,
  		Seances: 7151.6,
  		Entrees: 203.6,
  		RecetteGuichet: 1306.5,
  		RecetteMoyenneEntree: 6.42
  	},
  	{
  		Annee: 2013,
  		Seances: 7268.7,
  		Entrees: 193.7,
  		RecetteGuichet: 1250.9,
  		RecetteMoyenneEntree: 6.46
  	},
  	{
  		Annee: 2014,
  		Seances: 7581.5,
  		Entrees: 209.1,
  		RecetteGuichet: 1333.3,
  		RecetteMoyenneEntree: 6.38
  	},
  	{
  		Annee: 2015,
  		Seances: 7780.8,
  		Entrees: 205.4,
  		RecetteGuichet: 1331.7,
  		RecetteMoyenneEntree: 6.48
  	},
  	{
  		Annee: 2016,
  		Seances: 8017.5,
  		Entrees: 213.2,
  		RecetteGuichet: 1388.4,
  		RecetteMoyenneEntree: 6.51
  	},
  	{
  		Annee: 2017,
  		Seances: 8166.4,
  		Entrees: 209.4,
  		RecetteGuichet: 1380.6,
  		RecetteMoyenneEntree: 6.59
  	},
  	{
  		Annee: 2018,
  		Seances: 8453.4,
  		Entrees: 201.2,
  		RecetteGuichet: 1336.9,
  		RecetteMoyenneEntree: 6.64
  	},
  	{
  		Annee: 2019,
  		Seances: 8568.8,
  		Entrees: 213,
  		RecetteGuichet: 1447.4,
  		RecetteMoyenneEntree: 6.79
  	}
  ];
